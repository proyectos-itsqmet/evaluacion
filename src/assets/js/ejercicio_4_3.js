 ...
 sistemaAcademico() {
    ...
    let sumaPromedios = estudiantes.reduce((total, est) => total + est.promedio, 0);
    ...
    let estudiantesOrdenados = [...estudiantes].sort((a, b) => b.promedio - a.promedio);

    console.log(`Promedio general del grupo: ${promedioGeneral.toFixed(2)}`);
    console.log(`Estudiante con mejor promedio: ${mejorEstudiante.nombre} (${mejorEstudiante.promedio})`);
